...
fun Help(nav: NavHostController, modifier: Modifier = Modifier) {
    ...
    val faqs = remember {
        listOf(
            FaqItem("¿Puedo editar la información de mi negocio después del registro?", "Sí. Puedes actualizar la información general de tu negocio y administrar tus sucursales desde la sección Perfil en la barra de navegación inferior."),
            FaqItem("¿Qué hago si tengo problemas al escanear el código QR de un cliente?", "Asegúrate de tener buena conexión a internet y que el código QR esté bien enfocado y sin reflejos. Si el error persiste, puede ser que el cupón ya haya sido canjeado, haya expirado o sea inválido."),
            FaqItem("¿Hay límite de canjes diarios por promoción?", "Puedes establecer un Máximo por Día opcional al crear/editar la promoción."),
            FaqItem("¿Mis estadísticas son privadas?", "Sí, solo tú y los administradores de la app pueden ver el detalle de tus estadísticas.")
        )
    }
    ...
    Scaffold(
        ...
        bottomBar = {
            // Se utiliza la nueva barra de navegación para colaboradores
